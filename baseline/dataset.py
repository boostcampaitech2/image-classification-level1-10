...
class ChoiDataset(Dataset) :
    def __init__(self, data_dir, path_list, label_list, transform, aug_transform=None, mean=(0.548, 0.504, 0.479), std=(0.237, 0.247, 0.246), val_ratio=0.2, istrain =False) :
        self.X = []
        self.y = []
...
class ChoiAugmentation:
    def __init__(self, resize, mean, std, **args):
        self.transform = Compose([Resize(512, 384, p = 1.0),
...
class MaskBaseDataset(Dataset):
    ...
    def __init__(self, data_dir, mean=(0.548, 0.504, 0.479), std=(0.237, 0.247, 0.246), val_ratio=0.2, istrain =True):
        self.data_dir = data_dir
        self.mean = mean
        self.std = std
        self.val_ratio = val_ratio
